...
class Check(commands.GroupCog, name = "check"):
    ...
    async def ct(self, interaction: discord.Interaction, user: str):
        ...
        try:
            ...
            enemyGroups = enemyGroups = [5248163, 4886107, 15294045, 15635299, 15815549, 15815551, 15815554, 15815556, 13529471, 13529222, 13871657, 13819322, 16139753, 13439446, 13529342, 13529439, 13529455, 9898651, 11439837, 10134262, 3962491, 2795991, 2650759, 2682451, 6521883, 16637782, 16538494]
            mainGroup = 872876
            try:
